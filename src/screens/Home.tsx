...
const styles = StyleSheet.create({
  ...
  utilityCard: { flex: 1, height: 154, overflow: 'hidden', borderRadius: 16, borderWidth: 1, borderColor: 'rgba(255,255,255,0.7)', backgroundColor: 'rgba(255,255,255,0.8)', shadowColor: '#493A4D', shadowOpacity: 0.08, shadowRadius: 5, shadowOffset: { width: 0, height: 2 }, elevation: 2 },
  utilityImage: { width: '100%', height: 72 },
  utilityCopy: { flex: 1, justifyContent: 'center', paddingHorizontal: 10, paddingVertical: 5, backgroundColor: '#FFF' },
